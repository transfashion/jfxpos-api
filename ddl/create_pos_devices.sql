...
-- Sample Data
INSERT INTO pos_devices (device_id, device_code, api_key, secret, name, site_id, site_code, site_name, struct_id, struct_code, is_active)
VALUES 
    (1, 'pos-kasir-01', 'key_kasir_satu_123', 'secret_kasir_satu_999_xyz', 'POS Kasir Utama', 10, 'SITE01', 'Bandung Indah Plaza', 20, 'DEPT01', true),
    (2, 'pos-kasir-02', 'key_kasir_dua_456', 'secret_kasir_dua_888_abc', 'POS Kasir Cadangan', 10, 'SITE01', 'Bandung Indah Plaza', 20, 'DEPT01', true),
    (3, 'pos-kasir-03', 'key_kasir_tiga_789', 'secret_kasir_tiga_777_def', 'POS Kasir Foodcourt', 11, 'SITE02', 'Paris Van Java', 21, 'DEPT02', false) -- Contoh perangkat non-aktif
